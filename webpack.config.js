...
module.exports = {  //экспорт модулей для других файлов, чтобы было доступно в других файлах
  ...
  plugins: [
        ...
        new CopyPlugin({
            patterns: [
              { from: "/home/nataly/Рабочий стол/geek-brains/Курс 4 - JS 2 уровень/Вне урока/JS_shop_handmade/src/style",
              to: "/home/nataly/Рабочий стол/geek-brains/Курс 4 - JS 2 уровень/Вне урока/JS_shop_handmade/dist" }
           ],
          }),
